...
class DBusInterface {
   ...
   private:
    ...
    const char *introspection = DBUS_INTROSPECT_1_0_XML_DOCTYPE_DECL_NODE
        ...
        "      <arg name='landing_site_search_max_speed' type='d' direction='out' />\n"
        "      <arg name='landing_site_search_max_distance' type='d' direction='out' />\n"
        "      <arg name='landing_site_search_min_distance_after_abort' type='d' direction='out' />\n"
        "      <arg name='landing_site_search_strategy' type='s' direction='out' />\n"
        "      <arg name='landing_site_search_spiral_spacing' type='d' direction='out' />\n"
        "      <arg name='landing_site_search_spiral_points' type='u' direction='out' />\n"
        ...
        "      <arg name='landing_site_search_max_speed' type='d' direction='in' />\n"
        "      <arg name='landing_site_search_max_distance' type='d' direction='in' />\n"
        "      <arg name='landing_site_search_min_distance_after_abort' type='d' direction='in' />\n"
        "      <arg name='landing_site_search_strategy' type='s' direction='in' />\n"
        "      <arg name='landing_site_search_spiral_spacing' type='d' direction='in' />\n"
        "      <arg name='landing_site_search_spiral_points' type='u' direction='in' />\n"
